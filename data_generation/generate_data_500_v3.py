"""
Generate 500-sample 3D turbulence dataset.
Direct extension of validated generate_v3_correct.py.
"""
import numpy as np
import torch
...
def main():
    ...
    print(f"Generating 500 train + 100 val samples...")
    ...
    with h5py.File('data/turbulence_re1000_n64_500samples.h5', 'w') as f:
        ...
        print(f"\n[3] Stats: mean={mean:.6e}, std={std:.6e}")
    
    print("\nSaved: data/turbulence_re1000_n64_500samples.h5")
    ...
    with h5py.File('data/turbulence_re1000_n64_500samples.h5', 'r') as f:
