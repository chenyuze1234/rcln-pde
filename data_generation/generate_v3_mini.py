"""
V3 Mini: 50 train + 10 val for faster training
RTX 5070 optimized
"""
import numpy as np
import torch
...
def main():
    ...
    print(f"RTX 5070 detected: {device}")
    print(f"Generating MINI dataset (50 train + 10 val)...")
    print(f"dt={dt}, correlation target: 0.93\n")
    ...
    with h5py.File('data/experiment_v3_mini.h5', 'w') as f:
        print("[1] Training samples (50)...")
    ...
    print(f"\nSaved: data/experiment_v3_mini.h5")
    ...
    with h5py.File('data/experiment_v3_mini.h5', 'r') as f:
